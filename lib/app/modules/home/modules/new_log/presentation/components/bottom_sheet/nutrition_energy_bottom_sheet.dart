...
class NutritionEnergyBottomSheet extends StatefulWidget {
  ...
  final NutritionWithEnergyModel nutrition;
  final void Function(NutritionWithEnergyModel, double) onOkCallback;
...
class _NutritionEnergyBottomSheetState extends State<NutritionEnergyBottomSheet> {
  late double energy;
  late NutritionWithEnergyModel nutrition;
        ...
        : Container(
            ...
            child: Column(
              ...
              children: [
                ...
                //           children: [
                //             AdaptiveText(
                //                 text: nutrition[index].nutrition.name, textType: TextType.medium),
                //             const SizedBox(height: 8),
                //             _commonFieldWidget(
                //               nutrition[index].energy,
                //               (value) {
                //                 List<NutritionWithEnergyModel> auxList = List.from(nutrition);
                //                 NutritionWithEnergyModel? oldNutrition =
                //                     auxList.firstWhereOrNull((n) => n == nutrition[index]);
          ...
          children: [
            ...
            CustomButton.primaryNeutroSmall(
              ButtonParameters(
                text: 'OK',
                width: (MediaQuery.of(context).size.width - 2 * DefaultMargin.horizontal) * 0.45,
                onTap: () => widget.onOkCallback(nutrition, energy),
              ),
            ),
          ],
        ),
